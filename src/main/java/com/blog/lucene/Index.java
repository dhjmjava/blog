...
public class Index {
	 ...
	 * 初始化已有数据
	 */
	public void initIndex(String indexDir ,List<Blog> blogs)throws Exception{
	 ...
	 * @since JDK 1.6
	 */
	public void index(String indexDir ,Blog blog)throws Exception{
		directory = FSDirectory.open(new File(indexDir));
		IndexWriter writer = getWriter();
		writer.addDocument(addDataToIndex(blog));
		writer.commit();
	...
	//更新索引
    public void updateIndex(String indexDir ,Blog blog)throws Exception{
    	IndexWriter writer=getWriter();
